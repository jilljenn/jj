...
Qu'est-ce qu'un algorithme, quels exemples de petits bugs ont entraîné de grandes répercussions (`La Faute à l'algo <http://fautealgo.fr>`_) et comment les algorithmes peuvent discriminer de façon involontaire (cf. sa `revue de presse <http://fautealgo.fr/revue-de-presse/>`_) ?

- `Slides ia-senat.pdf <ia-senat.pdf>`_
...
- `Slides mangaki.pdf <mangaki.pdf>`_
- `Code source de Mangaki <https://bitbucket.org/mangaki/mangaki/>`_ sur Bitbucket
...
- `Slides bellman.pdf <bellman.pdf>`_
- `Références et code source slides Bellman <https://bitbucket.org/jilljenn/bellman/>`_ sur Bitbucket
...
- `Vidéo géométrie dans les jeux vidéo <http://www.dailymotion.com/video/x2mz3zf_la-geometrie-dans-le-jeu-video_school>`_ sur Dailymotion
- `Slides jeuxvideo <jeuxvideo/>`_
- `Un jeu de casse-briques <cassebriques/>`_ en JavaScript
- `Références et code source du casse-briques <https://github.com/jilljenn/refresh-canvas>`_ sur GitHub
...
- `Vidéo Keep Calm <https://www.youtube.com/watch?v=b6r0N4TXNpY>`_ sur YouTube
- `Slides keepcalm.pdf <keepcalm.pdf>`_
- `Références et code source Keep Calm <https://bitbucket.org/jilljenn/keep-calm>`_ sur Bitbucket
...
- `Slides grolopin.pdf <grolopin.pdf>`_  (oct. 2013)
- Pour en savoir plus, `cet article de Maxime Bourrigan sur Images des mathématiques <http://images.math.cnrs.fr/Dobble-et-la-geometrie-finie.html>`_
...
.. toctree::
   ...
   la-creativite-en-musique-et-en-mathematiques-pierre-boulez-et-alain-connes-1
   rencontre-dessinee-avec-lewis-trondheim-ens-de-lyon-2

Intelligence artificielle et apprentissage automatique
::::::::::::::::::::::::::::::::::::::::::::::::::::::

Au stage Turing de `Science Ouverte <http://www.scienceouverte.fr>`_, en novembre 2012.

- `Slides IA.pdf <IA.pdf>`_

Théorie des jeux
::::::::::::::::

- L'article Wikipédia sur les `jeux de Nim <https://fr.wikipedia.org/wiki/Jeux_de_Nim>`_
- La `résolution du quart de Singe (en anglais, « Ghost ») <http://blog.xkcd.com/2007/12/31/ghost/>`_ par Randall Munroe, l'auteur du webcomic `XKCD <http://xkcd.com>`_
- `La tablette de chocolat empoisonnée <http://www.lsv.ens-cachan.fr/~picaro/COURS/JPO/chomp.pdf>`_ par Claudine « Pikachu » Picaronny
